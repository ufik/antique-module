...
use Nette\Application\UI;
	...
	/* @var \WebCMS\AntiqueModule\Doctrine\Category */
	private $category;
	...
	public function actionUpdateCategory($idPage, $id) {
		...
		$this->category = new \WebCMS\AntiqueModule\Doctrine\Category();
	}
	...
	protected function createComponentCategoriesGrid($name) {
	    ...
	    $grid = $this->createGrid($this, $name, '\WebCMS\AntiqueModule\Doctrine\Category', array(
		array('by' => 'root', 'dir' => 'ASC'),
		array('by' => 'lft', 'dir' => 'ASC')
		), array(
		'language = ' . $this->state->language->getId(),
	...
	public function actionDefault($idPage) {
	    ...
	    if (count($main) == 0) {
		$main = new \WebCMS\AntiqueModule\Doctrine\Category;
		$main->setTitle('Main');
