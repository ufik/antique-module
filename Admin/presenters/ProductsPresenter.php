...
use Nette\Application\UI;
	...
	public function actionUpdateVariant($idPage, $idProduct, $id) {
		...
		$this->variant = new \WebCMS\AntiqueModule\Doctrine\Product;
	...
	public function createComponentParameterForm() {
	    ...
	    $parameters = $this->em->getRepository('\WebCMS\AntiqueModule\Doctrine\Parameter')->findAll();
	...
	public function parameterFormSubmitted($form) {
		...
		$parameter = $this->em->getRepository('\WebCMS\AntiqueModule\Doctrine\ParameterValue')->find($id);
		if($v){
